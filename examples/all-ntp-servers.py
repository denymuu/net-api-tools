  ...
  """
    ...
    for host in ntp_results.keys():
        ...
        if configured_ntp_servers == allowed_ntp_servers:
            ...
            print(
                Fore.GREEN + "Compliant NTP server list : " +
                str(allowed_ntp_servers)
            )
            print(
                Fore.GREEN + "Actual NTP server list : " +
                str(configured_ntp_servers)
            )
        else:
            print(
                Fore.RED
            ...
            print(Fore.RED + "Compliant server list : " +
                  str(allowed_ntp_servers))
            print(Fore.RED + "Actual server list : " +
                  str(configured_ntp_servers))
        # Demarcation print
        print("=" * 80)
